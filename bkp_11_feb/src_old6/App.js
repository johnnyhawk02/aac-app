...
function App() {
  ...
  const [options, setOptions] = useState({
    ...
    tilePadding: 10,
    tileGap: 10,
    imageSymbolGap: 20, // New property for the gap between the image and symbol sentence
  });
  ...
  // Updated processInput that supports newlines (as before)
  const processInput = (input) => {
    ...
    // Split input by newline to preserve line breaks
    ...
    <div className={`App ${options.monospaced ? 'monospaced' : ''}`}>
      ...
      {learningMode ? (
        ...
        <div className="sentence-section">
          ...
          {/* Apply the gap between image and symbol sentence */}
